...
class PresensiController extends Controller
{
    public function create() {
        ...
        $kode_pelanggan = Auth::guard('karyawan')->user()->kode_pelanggan;
        $lok_kantor = DB::table('pelanggan')->where('kode_pelanggan',$kode_pelanggan)->first();
    ...
    public function store(Request $request){
        ...
        $jam = date("H:i:s");
        $lok_kantor = DB::table('pelanggan')->where('kode_pelanggan',$kode_pelanggan)->first();
        $lok = explode(",",$lok_kantor->lokasi_pelanggan);
        ...
        if($radius >$lok_kantor->radius_pelanggan){
