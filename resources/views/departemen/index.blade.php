                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" id="nik" value="" class="form-control" name="kode_dept" placeholder="Kode Dept">
                          </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" id="nama_dept" value="" class="form-control" name="nama_dept" placeholder="Nama Dept">
                          </div>
                    </div>
                </div>
